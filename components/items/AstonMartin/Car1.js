    ...
    'cars': [
        {
            ...
            'transmission': 8,
            'displacement': '5204cc',
            'link': 'https://www.caranddriver.com/aston-martin/dbs-superleggera/specs/2021/aston-martin_dbs-superleggera_aston-martin-dbs-superleggera-volante_2021/413983'
        },
    ]
}
...
const images = {
    "Exterior": [
        { "uri": "https://i.ibb.co/Y3JDm3J/Exterior-1.jpg" },
        { "uri": "https://i.ibb.co/cCvJTMD/Exterior-2.jpg" },
        { "uri": "https://i.ibb.co/717BmqM/Exterior-3.jpg" },
        { "uri": "https://i.ibb.co/M7tDF9q/Exterior-4.jpg" },
        { "uri": "https://i.ibb.co/QrVvPzb/Exterior-5.jpg" },
        { "uri": "https://i.ibb.co/K7541PP/Exterior-6.jpg" },
    ],
    "Interior": [
        { "uri": "https://i.ibb.co/CQHVX52/Interior-1.jpg" },
        { "uri": "https://i.ibb.co/PQFm0jD/Interior-2.jpg" },
        { "uri": "https://i.ibb.co/4fvvmYQ/Interior-3.jpg" },
        { "uri": "https://i.ibb.co/M28T4xv/Interior-4.jpg" },
        { "uri": "https://i.ibb.co/0XtJnwk/Interior-5.jpg" },
        { "uri": "https://i.ibb.co/jwXRtKs/Interior-6.jpg" },
    ],
}
...
const specifications = {
    "specs": [
        {
            'type': 'Price Range',
            'desc': '$314,186 - $337,525'
        },
        {
            'type': 'Model Variants',
            'desc': ' DBS Superleggera Volante\n DBS Superleggera'
        },
        {
            'type': 'Vehicle Type',
        ...
        {
            'type': 'Engine Type',
            'desc': 'Twin-turbocharged and Intercooled DOHC 48-valve V-12, Aluminum block and heads, Port fuel injection'
        },
        {
            'type': 'Displacement',
            'desc': '5200 cc'
        ...
        {
            'type': 'Power',
            'desc': '715 hp @ 6500 rpm'
        },
        {
            'type': 'Torque',
            'desc': '663 lb-ft @ 1800 rpm'
        },
        {
            'type': 'Range',
            'desc': ' City: 462 km\n Highway: 726 km'
        ...
        {
            'type': 'Dimensions',
            'desc': ' Wheelbase: 110.4 in\n Length: 185.5 in\n Width: 77.5 in\n Height: 50.4 in'
        },
        {
            'type': 'Performance (C/D EST)',
            'desc': ' 100 kmph: 3.2 sec\n 160 kmph: 7.3 sec\n 400-meter: 11.0 sec\n Top speed: 340 kmph'
        },
        {
...
const Car1 = ({ navigation }) => {
    ...
    async function playEngineSound() {
        console.log('Loading Sound');
        const { sound } = await Audio.Sound.createAsync(
            require('../../../assets/audio/cars/AstonMartin/DBS-Superleggera_Engine.mp3')
        );
        setSound(sound);
    ...
    async function playAccelerationSound() {
        ...
        console.log('Loading Sound');
        const { sound } = await Audio.Sound.createAsync(
            require('../../../assets/audio/cars/AstonMartin/DBS-Superleggera_Acceleration.mp3')
        );
        setSound(sound);
