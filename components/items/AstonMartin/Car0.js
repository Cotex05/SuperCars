    ...
    'cars': [
        {
            ...
            'transmission': 8,
            'displacement': '5204cc',
            'link': 'https://www.caranddriver.com/aston-martin/db11/specs/2021/aston-martin_db11_aston-martin-db11-amr_2021/414130'
        },
    ]
}
...
const images = {
    "Exterior": [
        { "uri": "https://i.ibb.co/M7vQR8L/Exterior-1.jpg" },
        { "uri": "https://i.ibb.co/Sw91TZ3/Exterior-2.jpg" },
        { "uri": "https://i.ibb.co/59ZX5FQ/Exterior-3.jpg" },
        { "uri": "https://i.ibb.co/L1KDVWQ/Exterior-4.jpg" },
        { "uri": "https://i.ibb.co/qMwwZLZ/Exterior-5.jpg" },
        { "uri": "https://i.ibb.co/44LQYrz/Exterior-6.jpg" },
    ],
    "Interior": [
        { "uri": "https://i.ibb.co/sbKRDmP/Interior-1.jpg" },
        { "uri": "https://i.ibb.co/nzfkvpR/Interior-2.jpg" },
        { "uri": "https://i.ibb.co/3T6b4Vs/Interior-3.jpg" },
        { "uri": "https://i.ibb.co/879dJsp/Interior-4.jpg" },
        { "uri": "https://i.ibb.co/ftczBjN/Interior-5.jpg" },
        { "uri": "https://i.ibb.co/1q3jkS5/Interior-6.jpg" },
    ],
}
...
const specifications = {
    "specs": [
        ...
        {
            'type': 'Power',
            'desc': '630 hp @ 6500 rpm'
        },
        {
            'type': 'Torque',
            'desc': '516 lb-ft @ 1500 rpm'
        },
        {
            'type': 'Range',
            'desc': ' City: 495 km\n Highway: 725 km'
...
const Car0 = ({ navigation }) => {
    ...
    async function playEngineSound() {
        console.log('Loading Sound');
        const { sound } = await Audio.Sound.createAsync(
            require('../../../assets/audio/cars/AstonMartin/DB11_Engine.mp3')
        );
        setSound(sound);
    ...
    async function playAccelerationSound() {
        ...
        console.log('Loading Sound');
        const { sound } = await Audio.Sound.createAsync(
            require('../../../assets/audio/cars/AstonMartin/DB11_Acceleration.mp3')
        );
        setSound(sound);
