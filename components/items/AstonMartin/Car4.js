    ...
    'cars': [
        {
            ...
            'ncap': 4,
            'price': '$142,086 - $183,081',
            'hp': 503,
            'topSpeed': 306,
            'transmission': 8,
            'displacement': '3982cc',
            'link': 'https://www.caranddriver.com/aston-martin/vantage/specs/2021/aston-martin_vantage_aston-martin-vantage-roadster_2021/414058'
        },
    ]
}
...
const images = {
    "Exterior": [
        { "uri": "https://i.ibb.co/CMnGtsd/Exterior-1.jpg" },
        { "uri": "https://i.ibb.co/db6Pj7n/Exterior-2.jpg" },
        { "uri": "https://i.ibb.co/x1756xB/Exterior-3.jpg" },
        { "uri": "https://i.ibb.co/TgzSxZ8/Exterior-4.jpg" },
        { "uri": "https://i.ibb.co/C5xWrSg/Exterior-5.jpg" },
        { "uri": "https://i.ibb.co/NW7NVqn/Exterior-6.jpg" },
    ],
    "Interior": [
        { "uri": "https://i.ibb.co/Q6xGJGM/Interior-1.jpg" },
        { "uri": "https://i.ibb.co/D8HhTXW/Interior-2.jpg" },
        { "uri": "https://i.ibb.co/hHpqvc5/Interior-3.jpg" },
        { "uri": "https://i.ibb.co/zQ9BHGW/Interior-4.jpg" },
        { "uri": "https://i.ibb.co/5BBCPfH/Interior-5.jpg" },
        { "uri": "https://i.ibb.co/TBb7x2v/Interior-6.jpg" },
    ],
}
...
const specifications = {
    "specs": [
        {
            'type': 'Price Range',
            'desc': '$142,086 - $183,081'
        },
        {
            'type': 'Model Variants',
            'desc': ' Vantage Roadster (Convertible)\n Vantage Coupe'
        },
        {
            'type': 'Vehicle Type',
            'desc': 'Front-Engine, Rear-Wheel-Drive, 2 Passenger, 2-Door Hatchback'
        },
        {
            'type': 'Engine Type',
            'desc': 'Twin-turbocharged and intercooled DOHC 32-valve V-8, Aluminum block and heads, Direct fuel injection'
        },
        {
            'type': 'Displacement',
            'desc': '3982 cc'
        ...
        {
            'type': 'Power',
            'desc': '503 hp @ 6000 rpm'
        },
        {
            'type': 'Torque',
            'desc': '505 lb-ft @ 2000 rpm'
        },
        {
            'type': 'Range',
            'desc': ' City: 559 km\n Highway: 746 km'
        ...
        {
            'type': 'Dimensions',
            'desc': ' Wheelbase: 106.5 in\n Length: 175.8 in\n Width: 76.5 in\n Height: 50.1 in'
        },
        {
            'type': 'Performance (C/D EST)',
            'desc': ' 100 kmph: 3.6 sec\n 160 kmph: 7.6 sec\n 400-meter: 11.6 sec\n Top speed: 306 kmph'
        },
        {
...
const Car4 = ({ navigation }) => {
    ...
    async function playEngineSound() {
        console.log('Loading Sound');
        const { sound } = await Audio.Sound.createAsync(
            require('../../../assets/audio/cars/AstonMartin/Vantage_Engine.mp3')
        );
        setSound(sound);
    ...
    async function playAccelerationSound() {
        ...
        console.log('Loading Sound');
        const { sound } = await Audio.Sound.createAsync(
            require('../../../assets/audio/cars/AstonMartin/Vantage_Acceleration.mp3')
        );
        setSound(sound);
