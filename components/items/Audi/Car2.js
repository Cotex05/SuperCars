    ...
    'cars': [
        {
            ...
            'transmission': 7,
            'displacement': '2000cc',
            'link': 'https://www.caranddriver.com/audi/a5/specs'
        },
    ]
}
...
const images = {
    "Exterior": [
        { "uri": "https://i.ibb.co/dpS3cF2/Exterior-1.jpg" },
        { "uri": "https://i.ibb.co/ZTCqsFd/Exterior-2.jpg" },
        { "uri": "https://i.ibb.co/JcsVrdR/Exterior-3.jpg" },
        { "uri": "https://i.ibb.co/FHqNLG0/Exterior-4.jpg" },
        { "uri": "https://i.ibb.co/jyGGr1K/Exterior-5.jpg" },
        { "uri": "https://i.ibb.co/qNCzRbh/Exterior-6.jpg" },
    ],
    "Interior": [
        { "uri": "https://i.ibb.co/vDvgQhg/Interior-1.jpg" },
        { "uri": "https://i.ibb.co/F34qjGq/Interior-2.jpg" },
        { "uri": "https://i.ibb.co/1RCpGVZ/Interior-3.jpg" },
        { "uri": "https://i.ibb.co/P6q7Z2g/Interior-4.jpg" },
        { "uri": "https://i.ibb.co/x1kb0VH/Interior-5.jpg" },
        { "uri": "https://i.ibb.co/V2LQ2fQ/Interior-6.jpg" },
    ],
}
...
const specifications = {
    "specs": [
        ...
        {
            'type': 'Model Variants',
            'desc': ' A5 Cabriolet Premium 45 TFSI quattro\n A5 Cabriolet Premium Plus 45 TFSI quattro\n A5 Cabriolet Prestige 45 TFSI quattro'
        },
        {
            'type': 'Vehicle Type',
            'desc': 'Front-Engine, All-Wheel-Drive, 2+2 Passenger, 2-Door Subcompact'
        },
        {
            'type': 'Engine Type',
            'desc': 'Intercooled Turbo Gas/Electric I-4, Gasoline Direct Injection'
        },
        {
            'type': 'Displacement',
            'desc': '2000 cc'
        ...
        {
            'type': 'Dimensions',
            'desc': ' Wheelbase: 108.8 in\n Length: 184.9 in\n Width: 72.7 in\n Height: 54.5 in'
        },
        {
            'type': 'Performance (C/D EST)',
            'desc': ' 100 kmph: 5.4 sec\n 160 kmph: 12.3 sec\n 400-meter: 13.6 sec\n Top speed: 235 kmph'
        },
        {
...
const Car2 = ({ navigation }) => {
    ...
    async function playEngineSound() {
        console.log('Loading Sound');
        const { sound } = await Audio.Sound.createAsync(
            require('../../../assets/audio/cars/Audi/Audi_A5_Engine.mp3')
        );
        setSound(sound);
    ...
    async function playAccelerationSound() {
        console.log('Loading Sound');
        const { sound } = await Audio.Sound.createAsync(
            require('../../../assets/audio/cars/Audi/Audi_A5_Acceleration.mp3')
        );
        setSound(sound);
