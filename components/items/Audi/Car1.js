    ...
    'cars': [
        {
            ...
            'transmission': 7,
            'displacement': '2000cc',
            'link': 'https://www.caranddriver.com/audi/a4/specs'
        },
    ]
}
...
const images = {
    "Exterior": [
        { "uri": "https://i.ibb.co/BTSPhpM/Exterior-1.jpg" },
        { "uri": "https://i.ibb.co/rkLjgps/Exterior-2.jpg" },
        { "uri": "https://i.ibb.co/kXLCrX6/Exterior-3.jpg" },
        { "uri": "https://i.ibb.co/KbNM9Sp/Exterior-4.jpg" },
        { "uri": "https://i.ibb.co/RNwXV5f/Exterior-5.jpg" },
        { "uri": "https://i.ibb.co/q19DbCt/Exterior-6.jpg" },
    ],
    "Interior": [
        { "uri": "https://i.ibb.co/87154PM/Interior-1.jpg" },
        { "uri": "https://i.ibb.co/D7qjfGf/Interior-2.jpg" },
        { "uri": "https://i.ibb.co/8jb8V9Z/Interior-3.png" },
        { "uri": "https://i.ibb.co/0y5HGr4/Interior-4.jpg" },
        { "uri": "https://i.ibb.co/hRcnH97/Interior-5.jpg" },
        { "uri": "https://i.ibb.co/8DFzNfp/Interior-6.jpg" },
    ],
}
...
const specifications = {
    "specs": [
        ...
        {
            'type': 'Model Variants',
            'desc': ' A4 Sedan S line Premium 45 TFSI quattro\n A4 S Line Prestige 45 TFSI Quattro\n A4 S Line Premium Plus 45 TFSI Quattro\n A4 Sedan Premium 40 TFSI Quattro\n A4 Sedan Prestige 40 TFSI Quattro\n A4 Sedan Premium Plus 40 TFSI Quattro'
        },
        {
            'type': 'Vehicle Type',
            'desc': 'Front-Engine, All-Wheel-Drive, 2+3 Passenger, 4-Door Sedan'
        },
        {
            'type': 'Engine Type',
            'desc': 'Turbocharged & Intercooled DOHC 16-valve Inline-4, Iron Block & Aluminum Head, Direct Fuel Injection'
        },
        {
            'type': 'Displacement',
            'desc': '2000 cc'
        ...
        {
            'type': 'Power',
            'desc': '261 hp @ 6500 rpm'
        },
        {
            'type': 'Torque',
            'desc': '273 lb-ft @ 1600 rpm'
        },
        {
            'type': 'Range',
            'desc': ' City: 650 km\n Highway: 804 km'
        ...
        {
            'type': 'Transmission',
            'desc': '7-speed Dual-Clutch Automatic'
        },
        {
            'type': 'Dimensions',
            'desc': ' Wheelbase: 111.0 in\n Length: 185.5 in\n Width: 72.7 in\n Height: 56.2 in'
        },
        {
            'type': 'Performance (C/D EST)',
            'desc': ' 100 kmph: 4.8 sec\n 160 kmph: 12.9 sec\n 400-meter: 13.5 sec\n Top speed: 210 kmph'
        },
        {
            'type': 'EPA FUEL ECONOMY',
            'desc': ' City: 10.20 km/L\n Highway: 13.18 km/L'
        },
        {
            ...
            <ScrollView>
                <View style={HomeStyle.headerViewInner}>
                    ...
                    <View style={{ flexDirection: 'row' }}>
                        ...
                        <Text style={HomeStyle.carNameTitle}>{car['cars'][0].name}</Text>
                    </View>
                </View>
                ...
                <Animatable.View animation="zoomIn" useNativeDriver={true} easing="ease" delay={200} iterationCount={1}>
                    <View style={HomeStyle.modalView}>
                        ...
                        <View style={{ justifyContent: 'space-between', flexDirection: 'row', marginBottom: 20 }}>
                            <Text style={{ color: "#fff", fontSize: 25, paddingStart: 12, fontFamily: 'monospace', fontWeight: 'bold' }}>{car['cars'][0].name}</Text>
                            <Pressable
                        ...
                        <View style={{ backgroundColor: "#000", borderRadius: 30 }}>
                            <Animatable.Image useNativeDriver={true} animation="fadeInRight" easing="linear" delay={500} duration={1000} style={HomeStyle.carImg} source={{ uri: car['cars'][0].img }} />
                            <View>
