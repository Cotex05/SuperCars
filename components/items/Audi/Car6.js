...
const images = {
    "Exterior": [
        { "uri": "https://i.ibb.co/w0R0Ttg/Exterior-1.jpg" },
        { "uri": "https://i.ibb.co/GHFwDm8/Exterior-2.jpg" },
        { "uri": "https://i.ibb.co/q08q5QB/Exterior-3.jpg" },
        { "uri": "https://i.ibb.co/whG2PQp/Exterior-4.jpg" },
        { "uri": "https://i.ibb.co/K0f62XN/Exterior-5.jpg" },
        { "uri": "https://i.ibb.co/xzDFDz8/Exterior-6.jpg" },
    ],
    "Interior": [
        { "uri": "https://i.ibb.co/682r5Gm/Interior-1.jpg" },
        { "uri": "https://i.ibb.co/VvCDv2J/Interior-2.jpg" },
        { "uri": "https://i.ibb.co/gvBs77s/Interior-3.jpg" },
        { "uri": "https://i.ibb.co/ZWY7Sqp/Interior-4.jpg" },
        { "uri": "https://i.ibb.co/Jt8t9YN/Interior-5.jpg" },
        { "uri": "https://i.ibb.co/ZzShBLF/Interior-6.jpg" },
    ],
}
...
const specifications = {
    "specs": [
        {
            'type': 'Price Range',
            'desc': '$100,945 - $164,150'
        },
        {
            'type': 'Model Variants',
            'desc': ' E-Tron GT Premium Plus Quattro\n E-Tron GT Prestige Quattro\n E-Tron GT Quattro'
        },
        {
            'type': 'Vehicle Type',
            'desc': 'Front and Rear-Motor, All-Wheel-Drive, 5-passenger, 4-Door Hatchback'
        },
        {
            'type': 'Engine Type',
            'desc': 'Electric'
        ...
        {
            'type': 'Battery Pack',
            'desc': 'Liquid-Cooled Lithium-ion, 93.4 kWh'
        },
        {
            'type': 'Power-Train',
            'desc': '2 permanent-magnet synchronous AC'
        },
        {
            'type': 'Power',
            'desc': '637 hp'
        ...
        {
            'type': 'Transmission',
            'desc': ' 1-speed Direct-drive (front)\n 2-speed Automatic (rear)'
        },
        {
            'type': 'Dimensions',
            'desc': ' Wheelbase: 114.2 in\n Length: 196.4 in\n Width: 77.3 in\n Height: 54.9 in'
        },
        {
            'type': 'Performance (C/D EST)',
            'desc': ' 100 kmph: 3.0 sec\n 160 kmph: 6.6 sec\n 400-meter: 11.1 sec\n Top speed: 210 kmph'
        },
        {
            'type': 'EPA FUEL ECONOMY',
            'desc': ' City: 31 km/Ge (Gasoline Eq.)\n Highway: 32 km/Ge (Gasoline Eq.)'
        },
        {
...
const Car6 = ({ navigation }) => {
    ...
    async function playAccelerationSound() {
        console.log('Loading Sound');
        const { sound } = await Audio.Sound.createAsync(
            require('../../../assets/audio/cars/Audi/Audi_E-TRON_Acceleration.mp3')
        );
        setSound(sound);
